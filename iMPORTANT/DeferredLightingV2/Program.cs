...
namespace DeferredLightingV2
{
    ...
    class Program
    {
        ...
        /// </summary>
        //private const string ProjectToDebug = @"K:\code\iMPORTANT\DeferredLighting\DeferredLightingContent\DeferredLightingContent.contentproj";
        private const string ProjectToDebug = @"C:\data\iMPORTANT\DeferredLighting\DeferredLightingContent\DeferredLightingContent.contentproj";
       // private const string ProjectToDebug = @"K:\code\iMPORTANT\DeferredPipeline\DeferredPipeline.csproj";
        ...
        /// </summary>
        private const string SingleItem = @"Models\BUS_REAR.fbx";
