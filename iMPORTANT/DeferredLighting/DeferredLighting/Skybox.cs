...
namespace MyGame
{
    ...
    public class Skybox
    {
        ...
        public void Draw(Matrix view, Matrix projection, Vector3 cameraPosition)
        {
            ...
            {
                pass.Apply();
                Matrix baseWorld = Matrix.CreateScale(size)* Matrix.CreateTranslation(cameraPosition);
                ...
                foreach (ModelMesh mesh in skyBox.Meshes)
                {
                    ...
                    foreach (ModelMeshPart part in mesh.MeshParts)
                    {
                        ...
                        part.Effect.Parameters["World"].SetValue(baseWorld);
