...
{ 
    init();
    printf ("Accediendo a Memoria compartida mem_size 0x%x bytes",TOTMEM);
     MMF_SECTION = CreateFileMapping(INVALID_HANDLE_VALUE ,NULL,PAGE_READWRITE, 0,TOTMEM, TEXT("Global\\PROCESS_INTEROP_MEM")); // Nombre del archivo virtual
     if (MMF_SECTION == NULL) 
