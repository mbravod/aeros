...
void WLineEdit::wPaintEvent()
{
    ...
    switch(tipo){//Nos encontramos en el caso widget estatico
            ...
            case 0:
                    ...
                    //Volvemos a colocar el texto inicial de la etiqueta así como el color de fondo inicial (el asignado en la configuración)
...
void WLineEdit::Update()
{
    ...
    tipo = value;
    qDebug()<<"Estamos en el método 'update()'...";
