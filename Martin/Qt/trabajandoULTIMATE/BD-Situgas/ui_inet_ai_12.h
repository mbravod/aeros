/********************************************************************************
** Form generated from reading UI file 'inet_ai_12.ui'
**
...
#ifndef UI_INET_AI_12_H
#define UI_INET_AI_12_H
...
public:
    ...
    void setupUi(QWidget *Inet_AI_12)
    {
        if (Inet_AI_12->objectName().isEmpty())
            Inet_AI_12->setObjectName(QString::fromUtf8("Inet_AI_12"));
        Inet_AI_12->resize(485, 250);
        Inet_AI_12->setMinimumSize(QSize(485, 250));
        Inet_AI_12->setMaximumSize(QSize(485, 250));
        Inet_AI_12->setStyleSheet(QString::fromUtf8("background-color: rgb(128, 128, 128);\n"
""));
        lbNumDes_3 = new WLabel(Inet_AI_12);
        ...
        lbNumDes_1 = new WLabel(Inet_AI_12);
        ...
        lbNumDes_4 = new WLabel(Inet_AI_12);
        ...
        lbNumDes_6 = new WLabel(Inet_AI_12);
...
"color: rgb(255, 255, 255);"));
        ...
        btCerrar = new QPushButton(Inet_AI_12);
        ...
        lbNumDes_2 = new WLabel(Inet_AI_12);
        ...
        lbNumDes_5 = new WLabel(Inet_AI_12);
        ...
        retranslateUi(Inet_AI_12);

        QMetaObject::connectSlotsByName(Inet_AI_12);
    } // setupUi

    void retranslateUi(QWidget *Inet_AI_12)
    {
        Inet_AI_12->setWindowTitle(QApplication::translate("Inet_AI_12", "Inet_AI_12", 0, QApplication::UnicodeUTF8));
        lbNumDes_3->setText(QApplication::translate("Inet_AI_12", "0.00", 0, QApplication::UnicodeUTF8));
        lbUni_2->setText(QApplication::translate("Inet_AI_12", "PSIG", 0, QApplication::UnicodeUTF8));
        lbUni_6->setText(QString());
        lbUni_4->setText(QString());
        lbTit_5->setText(QApplication::translate("Inet_AI_12", "(REFACCI\303\223N)", 0, QApplication::UnicodeUTF8));
        lbNumDes_1->setText(QApplication::translate("Inet_AI_12", "0.00", 0, QApplication::UnicodeUTF8));
        lbNum_3->setText(QApplication::translate("Inet_AI_12", "3", 0, QApplication::UnicodeUTF8));
        lbNum_6->setText(QApplication::translate("Inet_AI_12", "6", 0, QApplication::UnicodeUTF8));
        lbNum_2->setText(QApplication::translate("Inet_AI_12", "2", 0, QApplication::UnicodeUTF8));
        lbUni_3->setText(QString());
        lbNumDes_4->setText(QApplication::translate("Inet_AI_12", "0.00", 0, QApplication::UnicodeUTF8));
        lbNumDes_6->setText(QApplication::translate("Inet_AI_12", "0.00", 0, QApplication::UnicodeUTF8));
        lbUni_1->setText(QApplication::translate("Inet_AI_12", "PSIG", 0, QApplication::UnicodeUTF8));
        lbNum_5->setText(QApplication::translate("Inet_AI_12", "5", 0, QApplication::UnicodeUTF8));
        lbNum_1->setText(QApplication::translate("Inet_AI_12", "1", 0, QApplication::UnicodeUTF8));
        lbTit_2->setText(QApplication::translate("Inet_AI_12", "NIVEL TANQUE DE LUB  DE CAJA DE ENGRAN DE", 0, QApplication::UnicodeUTF8));
        lbTit_3->setText(QApplication::translate("Inet_AI_12", "(REFACCI\303\223N)", 0, QApplication::UnicodeUTF8));
        lbIP->setText(QApplication::translate("Inet_AI_12", "LNET_A1.grf", 0, QApplication::UnicodeUTF8));
        btCerrar->setText(QApplication::translate("Inet_AI_12", "CERRAR", 0, QApplication::UnicodeUTF8));
        label->setText(QApplication::translate("Inet_AI_12", "NODE - N2N13  - A1", 0, QApplication::UnicodeUTF8));
        lbNum_4->setText(QApplication::translate("Inet_AI_12", "4", 0, QApplication::UnicodeUTF8));
        lbTit_1->setText(QApplication::translate("Inet_AI_12", "PRES SUMIN LUB DEL GENERADOR", 0, QApplication::UnicodeUTF8));
        lbTit_4->setText(QApplication::translate("Inet_AI_12", "(REFACCI\303\223N)", 0, QApplication::UnicodeUTF8));
        lbUni_5->setText(QString());
        lbNumDes_2->setText(QApplication::translate("Inet_AI_12", "0.00", 0, QApplication::UnicodeUTF8));
        lbTit_6->setText(QApplication::translate("Inet_AI_12", "(REFACCI\303\223N)", 0, QApplication::UnicodeUTF8));
        lbNumDes_5->setText(QApplication::translate("Inet_AI_12", "0.00", 0, QApplication::UnicodeUTF8));
...
namespace Ui {
    class Inet_AI_12: public Ui_Inet_AI_12 {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_INET_AI_12_H
