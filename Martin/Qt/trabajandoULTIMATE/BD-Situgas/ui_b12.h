...
public:
    ...
    void setupUi(QWidget *B12)
    {
        ...
        label_3->setProperty("Fondo_Inicial", QVariant(WLabel::Sin_color));
...
""));
        ...
        label_4->setProperty("Fondo_Inicial", QVariant(WLabel::Sin_color));
        label_5 = new WLabel(frame);
        label_5->setObjectName(QString::fromUtf8("label_5"));
        label_5->setGeometry(QRect(6, 90, 181, 16));
        label_5->setStyleSheet(QString::fromUtf8("color: rgb(255, 255, 255);"));
        label_5->setFont(font1);
        label_5->setProperty("Fondo_Inicial", QVariant(WLabel::Sin_color));
...
""));
        ...
        label_11->setProperty("Fondo_Inicial", QVariant(WLabel::Sin_color));
        ...
        lbGenFp->setProperty("Fondo_Inicial", QVariant(WLabel::Sin_color));
        ...
        lbGenMvar->setProperty("Fondo_Inicial", QVariant(WLabel::Sin_color));
        ...
        label_16->setProperty("Fondo_Inicial", QVariant(WLabel::Sin_color));
        ...
        lbGenMw->setProperty("Fondo_Inicial", QVariant(WLabel::Sin_color));
        ...
        label_18->setProperty("Fondo_Inicial", QVariant(WLabel::Sin_color));
        ...
        label_19->setProperty("Fondo_Inicial", QVariant(WLabel::Sin_color));
        ...
        label_20->setProperty("Fondo_Inicial", QVariant(WLabel::Sin_color));
        ...
        label_21->setProperty("Fondo_Inicial", QVariant(WLabel::Sin_color));
