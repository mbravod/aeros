...
#ifndef UI_INET_AI_19_H
#define UI_INET_AI_19_H
...
public:
    ...
    void setupUi(QWidget *Inet_AI_19)
    {
        if (Inet_AI_19->objectName().isEmpty())
            Inet_AI_19->setObjectName(QString::fromUtf8("Inet_AI_19"));
        Inet_AI_19->resize(485, 250);
        Inet_AI_19->setMinimumSize(QSize(485, 250));
        Inet_AI_19->setMaximumSize(QSize(485, 250));
        Inet_AI_19->setStyleSheet(QString::fromUtf8("background-color: rgb(128, 128, 128);"));
        lbNumDes_2 = new WLabel(Inet_AI_19);
        ...
        btCerrar = new QPushButton(Inet_AI_19);
        ...
        lbNumDes_5 = new WLabel(Inet_AI_19);
        ...
        lbNumDes_4 = new WLabel(Inet_AI_19);
        ...
        lbNumDes_6 = new WLabel(Inet_AI_19);
...
"background-color: rgb(74, 110, 195);"));
        ...
        lbNumDes_1 = new WLabel(Inet_AI_19);
        ...
        lbNumDes_3 = new WLabel(Inet_AI_19);
        ...
        retranslateUi(Inet_AI_19);

        QMetaObject::connectSlotsByName(Inet_AI_19);
    } // setupUi

    void retranslateUi(QWidget *Inet_AI_19)
    {
        Inet_AI_19->setWindowTitle(QApplication::translate("Inet_AI_19", "Inet_AI_19", 0, QApplication::UnicodeUTF8));
        lbNumDes_2->setText(QApplication::translate("Inet_AI_19", "0.00", 0, QApplication::UnicodeUTF8));
        btCerrar->setText(QApplication::translate("Inet_AI_19", "CERRAR", 0, QApplication::UnicodeUTF8));
        lbUni_1->setText(QString());
        lbUni_6->setText(QApplication::translate("Inet_AI_19", "\302\260F", 0, QApplication::UnicodeUTF8));
        lbNum_6->setText(QApplication::translate("Inet_AI_19", "6", 0, QApplication::UnicodeUTF8));
        lbNum_1->setText(QApplication::translate("Inet_AI_19", "1", 0, QApplication::UnicodeUTF8));
        lbTit_5->setText(QApplication::translate("Inet_AI_19", "TEMP AIRE ACOND DE VENT (SEC A)", 0, QApplication::UnicodeUTF8));
        lbUni_4->setText(QString());
        lbTit_2->setText(QApplication::translate("Inet_AI_19", "(REFACCI\303\223N)", 0, QApplication::UnicodeUTF8));
        lbNumDes_5->setText(QApplication::translate("Inet_AI_19", "0.00", 0, QApplication::UnicodeUTF8));
        lbNum_5->setText(QApplication::translate("Inet_AI_19", "5", 0, QApplication::UnicodeUTF8));
        lbTit_3->setText(QApplication::translate("Inet_AI_19", "(REFACCI\303\223N)", 0, QApplication::UnicodeUTF8));
        lbNum_2->setText(QApplication::translate("Inet_AI_19", "2", 0, QApplication::UnicodeUTF8));
        lbNum_4->setText(QApplication::translate("Inet_AI_19", "4", 0, QApplication::UnicodeUTF8));
        lbNum_3->setText(QApplication::translate("Inet_AI_19", "3", 0, QApplication::UnicodeUTF8));
        lbNumDes_4->setText(QApplication::translate("Inet_AI_19", "0.00", 0, QApplication::UnicodeUTF8));
        lbNumDes_6->setText(QApplication::translate("Inet_AI_19", "0.00", 0, QApplication::UnicodeUTF8));
        lbIP->setText(QApplication::translate("Inet_AI_19", "LNET_A1.grf", 0, QApplication::UnicodeUTF8));
        lbUni_2->setText(QString());
        lbUni_3->setText(QString());
        lbTit_1->setText(QApplication::translate("Inet_AI_19", "(REFACCI\303\223N)", 0, QApplication::UnicodeUTF8));
        lbNumDes_1->setText(QApplication::translate("Inet_AI_19", "0.00", 0, QApplication::UnicodeUTF8));
        lbTit_4->setText(QApplication::translate("Inet_AI_19", "(REFACCI\303\223N)", 0, QApplication::UnicodeUTF8));
        lbUni_5->setText(QApplication::translate("Inet_AI_19", "\302\260F", 0, QApplication::UnicodeUTF8));
        label->setText(QApplication::translate("Inet_AI_19", "NODE - N1N19  - RTD", 0, QApplication::UnicodeUTF8));
        lbNumDes_3->setText(QApplication::translate("Inet_AI_19", "0.00", 0, QApplication::UnicodeUTF8));
        lbTit_6->setText(QApplication::translate("Inet_AI_19", "TEMP AIRE ACOND DE VENT (SEC B)", 0, QApplication::UnicodeUTF8));
...
namespace Ui {
    class Inet_AI_19: public Ui_Inet_AI_19 {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_INET_AI_19_H
