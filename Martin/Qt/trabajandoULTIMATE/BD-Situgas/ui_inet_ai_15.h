/********************************************************************************
** Form generated from reading UI file 'inet_ai_15.ui'
**
...
#ifndef UI_INET_AI_15_H
#define UI_INET_AI_15_H
...
public:
    ...
    void setupUi(QWidget *Inet_AI_15)
    {
        if (Inet_AI_15->objectName().isEmpty())
            Inet_AI_15->setObjectName(QString::fromUtf8("Inet_AI_15"));
        Inet_AI_15->resize(485, 250);
        Inet_AI_15->setMinimumSize(QSize(485, 250));
        Inet_AI_15->setMaximumSize(QSize(485, 250));
        Inet_AI_15->setStyleSheet(QString::fromUtf8("background-color: rgb(128, 128, 128);"));
        lbNumDes_4 = new WLabel(Inet_AI_15);
        ...
        lbNumDes_5 = new WLabel(Inet_AI_15);
        ...
        lbNumDes_3 = new WLabel(Inet_AI_15);
        ...
        lbNumDes_1 = new WLabel(Inet_AI_15);
...
""));
        ...
        btCerrar = new QPushButton(Inet_AI_15);
        ...
        lbNumDes_6 = new WLabel(Inet_AI_15);
        ...
        lbNumDes_2 = new WLabel(Inet_AI_15);
        ...
        retranslateUi(Inet_AI_15);

        QMetaObject::connectSlotsByName(Inet_AI_15);
    } // setupUi

    void retranslateUi(QWidget *Inet_AI_15)
    {
        Inet_AI_15->setWindowTitle(QApplication::translate("Inet_AI_15", "Inet_AI_15", 0, QApplication::UnicodeUTF8));
        lbNumDes_4->setText(QApplication::translate("Inet_AI_15", "0.00", 0, QApplication::UnicodeUTF8));
        lbNumDes_5->setText(QApplication::translate("Inet_AI_15", "0.00", 0, QApplication::UnicodeUTF8));
        lbNum_2->setText(QApplication::translate("Inet_AI_15", "2", 0, QApplication::UnicodeUTF8));
        lbTit_5->setText(QApplication::translate("Inet_AI_15", "SUMDRO D DE TURB TEMP ACEITE RECUP TGBDA", 0, QApplication::UnicodeUTF8));
        lbUni_4->setText(QApplication::translate("Inet_AI_15", "\302\260F", 0, QApplication::UnicodeUTF8));
        lbNumDes_3->setText(QApplication::translate("Inet_AI_15", "0.00", 0, QApplication::UnicodeUTF8));
        lbNumDes_1->setText(QApplication::translate("Inet_AI_15", "0.00", 0, QApplication::UnicodeUTF8));
        lbNum_3->setText(QApplication::translate("Inet_AI_15", "3", 0, QApplication::UnicodeUTF8));
        lbNum_4->setText(QApplication::translate("Inet_AI_15", "4", 0, QApplication::UnicodeUTF8));
        lbTit_3->setText(QApplication::translate("Inet_AI_15", "SUMIDERO DE TURB TEMP ACEITE RECUP TGBBA", 0, QApplication::UnicodeUTF8));
        lbTit_1->setText(QApplication::translate("Inet_AI_15", "TEMP DE ACEITE AGB DE TURB RECUP", 0, QApplication::UnicodeUTF8));
        lbIP->setText(QApplication::translate("Inet_AI_15", "LNET_A1.grf", 0, QApplication::UnicodeUTF8));
        label->setText(QApplication::translate("Inet_AI_15", "NODE - N1N7  - RTD", 0, QApplication::UnicodeUTF8));
        btCerrar->setText(QApplication::translate("Inet_AI_15", "CERRAR", 0, QApplication::UnicodeUTF8));
        lbUni_1->setText(QApplication::translate("Inet_AI_15", "\302\260F", 0, QApplication::UnicodeUTF8));
        lbNumDes_6->setText(QApplication::translate("Inet_AI_15", "0.00", 0, QApplication::UnicodeUTF8));
        lbNumDes_2->setText(QApplication::translate("Inet_AI_15", "0.00", 0, QApplication::UnicodeUTF8));
        lbUni_5->setText(QApplication::translate("Inet_AI_15", "\302\260F", 0, QApplication::UnicodeUTF8));
        lbUni_6->setText(QApplication::translate("Inet_AI_15", "\302\260F", 0, QApplication::UnicodeUTF8));
        lbNum_5->setText(QApplication::translate("Inet_AI_15", "5", 0, QApplication::UnicodeUTF8));
        lbUni_2->setText(QApplication::translate("Inet_AI_15", "\302\260F", 0, QApplication::UnicodeUTF8));
        lbUni_3->setText(QApplication::translate("Inet_AI_15", "\302\260F", 0, QApplication::UnicodeUTF8));
        lbTit_4->setText(QApplication::translate("Inet_AI_15", "SUMDRO C DE TURB TEMP ACEITE RECUP TGBCA", 0, QApplication::UnicodeUTF8));
        lbTit_6->setText(QApplication::translate("Inet_AI_15", "SUMDRO E DE TURB TEMP ACEITE RECUP TGBEA", 0, QApplication::UnicodeUTF8));
        lbNum_6->setText(QApplication::translate("Inet_AI_15", "6", 0, QApplication::UnicodeUTF8));
        lbNum_1->setText(QApplication::translate("Inet_AI_15", "1", 0, QApplication::UnicodeUTF8));
        lbTit_2->setText(QApplication::translate("Inet_AI_15", "SUMIDERO DE TURB TGB/A ACEITE RECUP TGBA", 0, QApplication::UnicodeUTF8));
...
namespace Ui {
    class Inet_AI_15: public Ui_Inet_AI_15 {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_INET_AI_15_H
