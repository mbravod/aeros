...
public:
    ...
    void setupUi(QWidget *WTempCompA2)
    {
        ...
        lbCOMA2_1->setGeometry(QRect(92, 32, 41, 20));
        ...
        lbCOMA2_2->setGeometry(QRect(92, 47, 41, 20));
        ...
        lbCOMA2_3->setGeometry(QRect(92, 62, 41, 20));
        ...
        lbCOMA2_4->setGeometry(QRect(92, 78, 41, 20));
