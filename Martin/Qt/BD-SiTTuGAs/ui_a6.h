...
public:
    ...
    void retranslateUi(QWidget *A6)
    {
        ...
        ledApaFun->setId(QApplication::translate("A6", "p_START_PERM_OFF_RUN_B_NAME", 0, QApplication::UnicodeUTF8));
        lbApaFunT->setText(QApplication::translate("A6", "APAGADO/FUNCIONANDO", 0, QApplication::UnicodeUTF8));
        ledArraHid->setId(QApplication::translate("A6", "p_START_PERM_HYD_ST_OK", 0, QApplication::UnicodeUTF8));
        ...
        ledLavConAD->setId(QApplication::translate("A6", "p_START_PERM_WW_OH_B_NAME", 0, QApplication::UnicodeUTF8));
        ...
        ledHarLink->setId(QApplication::translate("A6", "p_START_PERM_MNET_OK_B_NAME", 0, QApplication::UnicodeUTF8));
        ledHardMicr->setId(QApplication::translate("A6", "p_START_PERM_LH_OK_B_NAME", 0, QApplication::UnicodeUTF8));
        lbRotNET->setText(QApplication::translate("A6", "ROTACI\303\223N NO ESTA EFECTU\303\201NDOSE", 0, QApplication::UnicodeUTF8));
        ledRotNE->setId(QApplication::translate("A6", "p_START_PERM_CRANK_OFF_B_NAME", 0, QApplication::UnicodeUTF8));
        ledCtrlMD->setId(QApplication::translate("A6", "p_START_PERM_FORCE_MODE_B_NAME", 0, QApplication::UnicodeUTF8));
        lbCtrlMDT->setText(QApplication::translate("A6", "CONTROL MANUAL DO DESHABILITADO", 0, QApplication::UnicodeUTF8));
        ledMen300N25_1->setId(QApplication::translate("A6", "p_START_PERM_N25LT300_B_NAME", 0, QApplication::UnicodeUTF8));
        ...
        ledBloqNo->setId(QApplication::translate("A6", "p_START_PERM_LOK4HROFF", 0, QApplication::UnicodeUTF8));
        lbNivTanTurT->setText(QApplication::translate("A6", "NIVEL TANQUE TURBINA OK", 0, QApplication::UnicodeUTF8));
        ledLavAguFu->setId(QApplication::translate("A6", "p_START_PERM_WWNOTAACTIVE_B_NAME", 0, QApplication::UnicodeUTF8));
        ...
        ledUnidFun->setId(QApplication::translate("A6", "p_START_PERM_RUNNING_B_NAME", 0, QApplication::UnicodeUTF8));
        ledTempAceTur->setId(QApplication::translate("A6", "p_START_PERM_TLUB", 0, QApplication::UnicodeUTF8));
        lbUnidFunT->setText(QApplication::translate("A6", "UNIDAD FUNCIONANDO", 0, QApplication::UnicodeUTF8));
        ledNivTanTur->setId(QApplication::translate("A6", "p_START_PERM_TLO_TNKLVL", 0, QApplication::UnicodeUTF8));
        ledTempEst->setId(QApplication::translate("A6", "p_START_PERM_STATOR_PRM_B_NAME", 0, QApplication::UnicodeUTF8));
        ...
        ledValSumCer->setId(QApplication::translate("A6", "p_START_PERM_SOV_CLSD_B_NAME", 0, QApplication::UnicodeUTF8));
        ...
        ledTempAceGen->setId(QApplication::translate("A6", "p_START_PERM_GLUBTNKTMP_B_NAME", 0, QApplication::UnicodeUTF8));
        ledValConb->setId(QApplication::translate("A6", "p_START_PERM_VMIN_STOP_B_NAME", 0, QApplication::UnicodeUTF8));
        ...
        ledT2May->setId(QApplication::translate("A6", "p_ONLINE_WW_T2GT50CMP", 0, QApplication::UnicodeUTF8));
        ledNivTan->setId(QApplication::translate("A6", "p_WTR_WASH_L56543_B_NAME", 0, QApplication::UnicodeUTF8));
        ledLavAgua->setId(QApplication::translate("A6", "p_ONLINE_WW_ONLINE01_SFC_STEP", 0, QApplication::UnicodeUTF8));
        lbNivTanT->setText(QApplication::translate("A6", "NIVEL TANQUE LAV AGUA", 0, QApplication::UnicodeUTF8));
        ledNsd->setId(QApplication::translate("A6", "p_SPEED_SW_NSDGT3590_A_COMPARE", 0, QApplication::UnicodeUTF8));
        ...
        ledMen300N25_2->setId(QApplication::translate("A6", "p_START_PERM_N25LT300_OK_B_NAME", 0, QApplication::UnicodeUTF8));
        ledNivTan_2->setId(QApplication::translate("A6", "p_WTR_WASH_LS6543_B_NAME", 0, QApplication::UnicodeUTF8));
        ledPerRot->setId(QApplication::translate("A6", "p_START_PERM_SDNN5_OK_B_NAME", 0, QApplication::UnicodeUTF8));
        lbNivTanT_2->setText(QApplication::translate("A6", "NIVEL TANQUE LAV AGUA", 0, QApplication::UnicodeUTF8));
        ledT48Men->setId(QApplication::translate("A6", "p_START_PERM_T48LT200", 0, QApplication::UnicodeUTF8));
