...
"background-color: rgba(255, 255, 255, 0);"));
        btnHabDes = new QPushButton(B8);
        btnHabDes->setObjectName(QString::fromUtf8("btnHabDes"));
        btnHabDes->setGeometry(QRect(524, 619, 108, 31));
        btnHabDes->setFont(font2);
        btnHabDes->setStyleSheet(QString::fromUtf8("background-color: rgb(212, 208, 200);"));
...
"background-color: rgba(255, 255, 255, 0);"));
        ...
        flama_SectorF = new Flama_SectorF(B8);
        flama_SectorF->setObjectName(QString::fromUtf8("flama_SectorF"));
        flama_SectorF->setGeometry(QRect(0, 0, 1024, 662));
        flama_SectorG = new Flama_SectorG(B8);
        flama_SectorG->setObjectName(QString::fromUtf8("flama_SectorG"));
        flama_SectorG->setGeometry(QRect(0, 0, 1024, 662));
        flama_SectorH = new Flama_SectorH(B8);
        flama_SectorH->setObjectName(QString::fromUtf8("flama_SectorH"));
        flama_SectorH->setGeometry(QRect(0, 0, 1024, 662));
        flama_SectorI = new Flama_SectorI(B8);
        flama_SectorI->setObjectName(QString::fromUtf8("flama_SectorI"));
        flama_SectorI->setGeometry(QRect(0, 0, 1024, 662));
        flama_SectorJ = new Flama_SectorJ(B8);
        flama_SectorJ->setObjectName(QString::fromUtf8("flama_SectorJ"));
        flama_SectorJ->setGeometry(QRect(0, 0, 1024, 662));
        flama_SectorK = new Flama_SectorK(B8);
        flama_SectorK->setObjectName(QString::fromUtf8("flama_SectorK"));
        flama_SectorK->setGeometry(QRect(0, 0, 1024, 662));
        flama_SectorL = new Flama_SectorL(B8);
        flama_SectorL->setObjectName(QString::fromUtf8("flama_SectorL"));
        flama_SectorL->setGeometry(QRect(0, 0, 1024, 662));
        lbIMGFondo->raise();
        lbUnit3->raise();
        lbTexto_0->raise();
        lbTexto_1->raise();
    ...
    void retranslateUi(QWidget *B8)
    {
        ...
        btnHabDes->setText(QApplication::translate("B8", "HAB/DESHAB", 0, QApplication::UnicodeUTF8));
