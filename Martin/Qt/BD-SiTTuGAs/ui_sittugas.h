...
**
** Created: Thu 12. Dec 21:16:34 2013
...
public:
    ...
    void setupUi(QWidget *SiTTuGAs)
    {
        ...
        label_2 = new QLabel(SiTTuGAs);
        label_2->setObjectName(QString::fromUtf8("label_2"));
        label_2->setGeometry(QRect(0, 0, 1024, 261));
        label_2->setStyleSheet(QString::fromUtf8("background-color: rgb(136, 136, 136);"));
        label_2->raise();
        ButtonBarBOP->raise();
        ButtonBar->raise();
        mdiArea->raise();
