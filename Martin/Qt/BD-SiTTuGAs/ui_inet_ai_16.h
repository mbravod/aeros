/********************************************************************************
** Form generated from reading UI file 'inet_ai_16.ui'
**
...
#ifndef UI_INET_AI_16_H
#define UI_INET_AI_16_H
...
public:
    ...
    void setupUi(QWidget *Inet_AI_16)
    {
        if (Inet_AI_16->objectName().isEmpty())
            Inet_AI_16->setObjectName(QString::fromUtf8("Inet_AI_16"));
        Inet_AI_16->resize(485, 250);
        Inet_AI_16->setMinimumSize(QSize(485, 250));
        Inet_AI_16->setMaximumSize(QSize(485, 250));
        Inet_AI_16->setStyleSheet(QString::fromUtf8("background-color: rgb(128, 128, 128);"));
        lbNum_1 = new WLabel(Inet_AI_16);
...
"color: rgb(255, 255, 255);"));
        ...
        lbNumDes_3 = new WLabel(Inet_AI_16);
        ...
        lbNumDes_2 = new WLabel(Inet_AI_16);
        ...
        lbNumDes_5 = new WLabel(Inet_AI_16);
        ...
        lbNumDes_4 = new WLabel(Inet_AI_16);
        ...
        lbNumDes_1 = new WLabel(Inet_AI_16);
        ...
        btCerrar = new QPushButton(Inet_AI_16);
        ...
        lbNumDes_6 = new WLabel(Inet_AI_16);
        ...
        retranslateUi(Inet_AI_16);

        QMetaObject::connectSlotsByName(Inet_AI_16);
    } // setupUi

    void retranslateUi(QWidget *Inet_AI_16)
    {
        Inet_AI_16->setWindowTitle(QApplication::translate("Inet_AI_16", "Inet_AI_16", 0, QApplication::UnicodeUTF8));
        lbNum_1->setText(QApplication::translate("Inet_AI_16", "1", 0, QApplication::UnicodeUTF8));
        lbUni_5->setText(QApplication::translate("Inet_AI_16", "\302\260F", 0, QApplication::UnicodeUTF8));
        lbTit_5->setText(QApplication::translate("Inet_AI_16", "SUMDRO D DE TURB TEMP ACEITE RECUP TGBDB", 0, QApplication::UnicodeUTF8));
        lbUni_2->setText(QApplication::translate("Inet_AI_16", "\302\260F", 0, QApplication::UnicodeUTF8));
        lbUni_3->setText(QApplication::translate("Inet_AI_16", "\302\260F", 0, QApplication::UnicodeUTF8));
        lbTit_3->setText(QApplication::translate("Inet_AI_16", "SUMIDERO DE TURB TEMP ACEITE RECUP TGBBB", 0, QApplication::UnicodeUTF8));
        lbTit_1->setText(QApplication::translate("Inet_AI_16", "TEMP DE ACEITE DE TURB RECUP TAGBB", 0, QApplication::UnicodeUTF8));
        lbNum_3->setText(QApplication::translate("Inet_AI_16", "3", 0, QApplication::UnicodeUTF8));
        lbNum_4->setText(QApplication::translate("Inet_AI_16", "4", 0, QApplication::UnicodeUTF8));
        lbIP->setText(QApplication::translate("Inet_AI_16", "LNET_A1.grf", 0, QApplication::UnicodeUTF8));
        lbTit_2->setText(QApplication::translate("Inet_AI_16", "SUMIDERO DE TURB TGB/A ACEITE RECUP TGBA", 0, QApplication::UnicodeUTF8));
        lbNumDes_3->setText(QApplication::translate("Inet_AI_16", "0.00", 0, QApplication::UnicodeUTF8));
        lbNum_6->setText(QApplication::translate("Inet_AI_16", "6", 0, QApplication::UnicodeUTF8));
        lbNum_2->setText(QApplication::translate("Inet_AI_16", "2", 0, QApplication::UnicodeUTF8));
        lbTit_4->setText(QApplication::translate("Inet_AI_16", "SUMDRO C DE TURB TEMP ACEITE RECUP TGBCB", 0, QApplication::UnicodeUTF8));
        lbNumDes_2->setText(QApplication::translate("Inet_AI_16", "0.00", 0, QApplication::UnicodeUTF8));
        lbNumDes_5->setText(QApplication::translate("Inet_AI_16", "0.00", 0, QApplication::UnicodeUTF8));
        lbUni_4->setText(QApplication::translate("Inet_AI_16", "\302\260F", 0, QApplication::UnicodeUTF8));
        lbUni_1->setText(QApplication::translate("Inet_AI_16", "\302\260F", 0, QApplication::UnicodeUTF8));
        lbNum_5->setText(QApplication::translate("Inet_AI_16", "5", 0, QApplication::UnicodeUTF8));
        lbNumDes_4->setText(QApplication::translate("Inet_AI_16", "0.00", 0, QApplication::UnicodeUTF8));
        lbTit_6->setText(QApplication::translate("Inet_AI_16", "SUMDRO E DE TURB TEMP ACEITE RECUP TGBEB", 0, QApplication::UnicodeUTF8));
        lbUni_6->setText(QApplication::translate("Inet_AI_16", "\302\260F", 0, QApplication::UnicodeUTF8));
        label->setText(QApplication::translate("Inet_AI_16", "NODE - N1N8  - RTD", 0, QApplication::UnicodeUTF8));
        lbNumDes_1->setText(QApplication::translate("Inet_AI_16", "0.00", 0, QApplication::UnicodeUTF8));
        btCerrar->setText(QApplication::translate("Inet_AI_16", "CERRAR", 0, QApplication::UnicodeUTF8));
        lbNumDes_6->setText(QApplication::translate("Inet_AI_16", "0.00", 0, QApplication::UnicodeUTF8));
...
namespace Ui {
    class Inet_AI_16: public Ui_Inet_AI_16 {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_INET_AI_16_H
