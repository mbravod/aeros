...
public:
    ...
    void setupUi(QWidget *Inet_AI_17)
    {
        ...
        lbNumDes_1 = new WLabel(Inet_AI_17);
...
"color: rgb(255, 255, 255);"));
        ...
        lbNumDes_4 = new WLabel(Inet_AI_17);
        ...
        lbNumDes_3 = new WLabel(Inet_AI_17);
        ...
        lbNumDes_6 = new WLabel(Inet_AI_17);
        ...
        lbNumDes_2 = new WLabel(Inet_AI_17);
        ...
        lbNumDes_5 = new WLabel(Inet_AI_17);
