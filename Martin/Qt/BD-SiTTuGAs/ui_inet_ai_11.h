/********************************************************************************
** Form generated from reading UI file 'inet_ai_11.ui'
**
** Created: Thu 12. Dec 21:16:49 2013
**      by: Qt User Interface Compiler version 4.7.4
**
** WARNING! All changes made in this file will be lost when recompiling UI file!
********************************************************************************/

#ifndef UI_INET_AI_11_H
#define UI_INET_AI_11_H
...
public:
    ...
    void setupUi(QWidget *Inet_AI_11)
    {
        if (Inet_AI_11->objectName().isEmpty())
            Inet_AI_11->setObjectName(QString::fromUtf8("Inet_AI_11"));
        Inet_AI_11->resize(485, 250);
        Inet_AI_11->setMinimumSize(QSize(485, 250));
        Inet_AI_11->setMaximumSize(QSize(485, 250));
        Inet_AI_11->setStyleSheet(QString::fromUtf8("background-color: rgb(128, 128, 128);"));
        lbUni_4 = new WLabel(Inet_AI_11);
...
"color: rgb(255, 255, 255);"));
        ...
        retranslateUi(Inet_AI_11);

        QMetaObject::connectSlotsByName(Inet_AI_11);
    } // setupUi

    void retranslateUi(QWidget *Inet_AI_11)
    {
        Inet_AI_11->setWindowTitle(QApplication::translate("Inet_AI_11", "Inet_AI_11", 0, QApplication::UnicodeUTF8));
        lbUni_4->setText(QApplication::translate("Inet_AI_11", "PSIG", 0, QApplication::UnicodeUTF8));
        lbUni_5->setText(QApplication::translate("Inet_AI_11", "PSIG", 0, QApplication::UnicodeUTF8));
        label->setText(QApplication::translate("Inet_AI_11", "NODE - N2N12  - A1", 0, QApplication::UnicodeUTF8));
        lbNum_5->setText(QApplication::translate("Inet_AI_11", "5", 0, QApplication::UnicodeUTF8));
        lbNum_2->setText(QApplication::translate("Inet_AI_11", "2", 0, QApplication::UnicodeUTF8));
        lbNumDes_4->setText(QApplication::translate("Inet_AI_11", "0.00", 0, QApplication::UnicodeUTF8));
        lbTit_3->setText(QApplication::translate("Inet_AI_11", "NIV TANQ ACEITE LUB GEN CIER GRAD (NDE)", 0, QApplication::UnicodeUTF8));
        lbNum_6->setText(QApplication::translate("Inet_AI_11", "6", 0, QApplication::UnicodeUTF8));
        lbNumDes_6->setText(QApplication::translate("Inet_AI_11", "0.00", 0, QApplication::UnicodeUTF8));
        btCerrar->setText(QApplication::translate("Inet_AI_11", "CERRAR", 0, QApplication::UnicodeUTF8));
        lbTit_5->setText(QApplication::translate("Inet_AI_11", "PRES SUMIN LUB DEL GENERADOR", 0, QApplication::UnicodeUTF8));
        lbNumDes_3->setText(QApplication::translate("Inet_AI_11", "0.00", 0, QApplication::UnicodeUTF8));
        lbTit_2->setText(QApplication::translate("Inet_AI_11", "ENTRD BOMBA ACE ALJIB PRES", 0, QApplication::UnicodeUTF8));
        lbUni_2->setText(QApplication::translate("Inet_AI_11", "PSIG", 0, QApplication::UnicodeUTF8));
        lbNum_4->setText(QApplication::translate("Inet_AI_11", "4", 0, QApplication::UnicodeUTF8));
        lbTit_1->setText(QApplication::translate("Inet_AI_11", "NIV TANQ ACEITE LUB GEN CIER GRAD (DE)", 0, QApplication::UnicodeUTF8));
        lbUni_3->setText(QApplication::translate("Inet_AI_11", "MA", 0, QApplication::UnicodeUTF8));
        lbUni_6->setText(QApplication::translate("Inet_AI_11", "PSIG", 0, QApplication::UnicodeUTF8));
        lbNumDes_5->setText(QApplication::translate("Inet_AI_11", "0.00", 0, QApplication::UnicodeUTF8));
        lbTit_4->setText(QApplication::translate("Inet_AI_11", "PRES SUMIN LUB DEL GENERADOR", 0, QApplication::UnicodeUTF8));
        lbNumDes_2->setText(QApplication::translate("Inet_AI_11", "0.00", 0, QApplication::UnicodeUTF8));
        lbIP->setText(QApplication::translate("Inet_AI_11", "LNET_A1.grf", 0, QApplication::UnicodeUTF8));
        lbUni_1->setText(QApplication::translate("Inet_AI_11", "MA", 0, QApplication::UnicodeUTF8));
        lbNum_1->setText(QApplication::translate("Inet_AI_11", "1", 0, QApplication::UnicodeUTF8));
        lbNum_3->setText(QApplication::translate("Inet_AI_11", "3", 0, QApplication::UnicodeUTF8));
        lbNumDes_1->setText(QApplication::translate("Inet_AI_11", "0.00", 0, QApplication::UnicodeUTF8));
        lbTit_6->setText(QApplication::translate("Inet_AI_11", "PRES SUMIN LUB DEL GENERADOR", 0, QApplication::UnicodeUTF8));
...
namespace Ui {
    class Inet_AI_11: public Ui_Inet_AI_11 {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_INET_AI_11_H
