/********************************************************************************
** Form generated from reading UI file 'grupocurves.ui'
**
** Created: Sun 13. Oct 17:33:15 2013
**      by: Qt User Interface Compiler version 4.7.4
**
** WARNING! All changes made in this file will be lost when recompiling UI file!
********************************************************************************/

#ifndef UI_GRUPOCURVES_H
#define UI_GRUPOCURVES_H
...
public:
    ...
    void setupUi(QDialog *GrupoCurves)
    {
        if (GrupoCurves->objectName().isEmpty())
            GrupoCurves->setObjectName(QString::fromUtf8("GrupoCurves"));
        GrupoCurves->resize(524, 493);
        gridLayout_9 = new QGridLayout(GrupoCurves);
        gridLayout_9->setObjectName(QString::fromUtf8("gridLayout_9"));
        gridLayout_8 = new QGridLayout();
        gridLayout_8->setObjectName(QString::fromUtf8("gridLayout_8"));
        groupBox_5 = new QGroupBox(GrupoCurves);
        ...
        tabWidget = new QTabWidget(GrupoCurves);
        ...
        retranslateUi(GrupoCurves);
        QObject::connect(cerrar, SIGNAL(clicked()), GrupoCurves, SLOT(reject()));
        QObject::connect(cerrarE, SIGNAL(clicked()), GrupoCurves, SLOT(reject()));

        SeleccSist->setCurrentIndex(-1);
        tabWidget->setCurrentIndex(0);


        QMetaObject::connectSlotsByName(GrupoCurves);
    } // setupUi

    void retranslateUi(QDialog *GrupoCurves)
    {
        GrupoCurves->setWindowTitle(QApplication::translate("GrupoCurves", "Dialog", 0, QApplication::UnicodeUTF8));
        groupBox_5->setTitle(QApplication::translate("GrupoCurves", "Seleccionar Sistema", 0, QApplication::UnicodeUTF8));
        label_4->setText(QString());
        groupBox->setTitle(QApplication::translate("GrupoCurves", "Listado de Variables", 0, QApplication::UnicodeUTF8));
        groupBox_2->setTitle(QApplication::translate("GrupoCurves", "Grupo de Variables", 0, QApplication::UnicodeUTF8));
        rootD->setText(QString());
        guardar->setText(QApplication::translate("GrupoCurves", "Guardar", 0, QApplication::UnicodeUTF8));
        guardarcomo->setText(QApplication::translate("GrupoCurves", "Guardar como", 0, QApplication::UnicodeUTF8));
        cerrar->setText(QApplication::translate("GrupoCurves", "Cerrar", 0, QApplication::UnicodeUTF8));
        tabWidget->setTabText(tabWidget->indexOf(tab), QApplication::translate("GrupoCurves", "Nuevo Grupo", 0, QApplication::UnicodeUTF8));
        groupBox_3->setTitle(QApplication::translate("GrupoCurves", "Listado de Variables", 0, QApplication::UnicodeUTF8));
        groupBox_4->setTitle(QApplication::translate("GrupoCurves", "Variables monitoreadas", 0, QApplication::UnicodeUTF8));
        label_5->setText(QApplication::translate("GrupoCurves", "Archivo:", 0, QApplication::UnicodeUTF8));
        abrir->setText(QApplication::translate("GrupoCurves", "Abrir", 0, QApplication::UnicodeUTF8));
        guardarE->setText(QApplication::translate("GrupoCurves", "Guardar", 0, QApplication::UnicodeUTF8));
        cerrarE->setText(QApplication::translate("GrupoCurves", "Cerrar", 0, QApplication::UnicodeUTF8));
        tabWidget->setTabText(tabWidget->indexOf(tab_2), QApplication::translate("GrupoCurves", "Editar Grupo", 0, QApplication::UnicodeUTF8));
    } // retranslateUi

};

namespace Ui {
    class GrupoCurves: public Ui_GrupoCurves {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_GRUPOCURVES_H
