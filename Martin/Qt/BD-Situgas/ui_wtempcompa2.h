...
public:
    ...
    void setupUi(QWidget *WTempCompA2)
    {
        ...
        lbTemCOMA2T = new QLabel(WTempCompA2);
        lbTemCOMA2T->setObjectName(QString::fromUtf8("lbTemCOMA2T"));
        lbTemCOMA2T->setGeometry(QRect(4, 4, 161, 20));
        QFont font;
        font.setFamily(QString::fromUtf8("Verdana"));
        font.setPointSize(9);
        font.setBold(true);
        font.setWeight(75);
        lbTemCOMA2T->setFont(font);
        lbTemCOMA2T->setStyleSheet(QString::fromUtf8("background-color: rgb(192, 192, 192);"));
    ...
    void retranslateUi(QWidget *WTempCompA2)
    {
        ...
        lbTemCOMA2T->setText(QApplication::translate("WTempCompA2", "TEMP COMPRESOR DE A", 0, QApplication::UnicodeUTF8));
