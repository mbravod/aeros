...
public:
    ...
    void setupUi(QWidget *Inet_AI_18)
    {
        ...
        lbNumDes_1 = new QLabel(Inet_AI_18);
...
"background-color: rgb(74, 110, 195);"));
        ...
        lbNumDes_4 = new QLabel(Inet_AI_18);
        ...
        lbNumDes_6 = new QLabel(Inet_AI_18);
        ...
        lbNumDes_2 = new QLabel(Inet_AI_18);
