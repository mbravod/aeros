...
public:
    ...
    void setupUi(QWidget *Inet_AI_11)
    {
        ...
        lbNumDes_4 = new QLabel(Inet_AI_11);
        ...
        lbNumDes_6 = new QLabel(Inet_AI_11);
        ...
        lbNumDes_5 = new QLabel(Inet_AI_11);
...
"color: rgb(255, 255, 255);"));
        ...
        lbNumDes_1 = new QLabel(Inet_AI_11);
