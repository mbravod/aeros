...
**
** Created: Sat 12. Oct 21:52:12 2013
...
public:
    ...
    void setupUi(QWidget *D4)
    {
        ...
        lbSupT->setFrameShape(QFrame::Box);
        lbSupT->setFrameShadow(QFrame::Sunken);
        lbSupT->setLineWidth(1);
        lbSupT->setAlignment(Qt::AlignCenter);
        lbCtrlT = new QLabel(frame_2);
        ...
        lbCtrlT->setFrameShape(QFrame::Box);
        lbCtrlT->setFrameShadow(QFrame::Sunken);
        lbCtrlT->setAlignment(Qt::AlignCenter);
        lbContT = new QLabel(frame_2);
...
"color: rgb(0, 0, 126);"));
        ...
        lbIfixT->setFrameShape(QFrame::Box);
        lbIfixT->setFrameShadow(QFrame::Sunken);
        lbIfixT->setAlignment(Qt::AlignCenter);
        lbifixT = new QLabel(frame_4);
        lbifixT->setObjectName(QString::fromUtf8("lbifixT"));
...
"color: rgb(0, 0, 126);"));
        lbRegT->setAlignment(Qt::AlignCenter);
...
"color: rgb(0, 0, 126);"));
        lbMicroT->setAlignment(Qt::AlignCenter);
        lbSoftT = new QLabel(frame_5);
        ...
        lbSoftT->setFrameShape(QFrame::Box);
        lbSoftT->setFrameShadow(QFrame::Sunken);
        lbSoftT->setAlignment(Qt::AlignCenter);
        lbCtrlAssT = new QLabel(frame_5);
...
"color: rgb(0, 0, 126);"));
        lbCtrlAssT->setAlignment(Qt::AlignCenter);
        lbLogT = new QLabel(frame_5);
...
"color: rgb(0, 0, 126);"));
        lbLogT->setAlignment(Qt::AlignCenter);
        lbGapT = new QLabel(frame_5);
...
"color: rgb(0, 0, 126);"));
        lbGapT->setAlignment(Qt::AlignCenter);
        ...
        lbUtilT->setFrameShape(QFrame::Box);
        lbUtilT->setFrameShadow(QFrame::Sunken);
        lbUtilT->setAlignment(Qt::AlignCenter);
        lbUnit3 = new QLabel(D4);
        ...
        lbIMGFondo->setPixmap(QPixmap(QString::fromUtf8(":/Resources/PNG/D4.png")));
        lbIMGFondo->raise();
        frame->raise();
        lbUnit3->raise();
        btnIMPPant->raise();
