...
**
** Created: Sat 12. Oct 21:52:31 2013
...
public:
    ...
    void setupUi(QWidget *F1)
    {
        ...
        F1->setStyleSheet(QString::fromUtf8("background-color: rgb(168, 168, 168);"));
        lbIMGFondo = new QLabel(F1);
        lbIMGFondo->setObjectName(QString::fromUtf8("lbIMGFondo"));
        lbIMGFondo->setGeometry(QRect(0, 0, 1024, 662));
        lbIMGFondo->setPixmap(QPixmap(QString::fromUtf8(":/Resources/PNG/F1.png")));
