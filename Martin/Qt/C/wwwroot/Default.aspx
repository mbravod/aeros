							...
							<!-- Header -->
								<header id="header">
									<div class="inner">
										...
										<!-- Logo -->
											<h1><a href="#" id="logo">CNCAOI -    <% Response.Write("Bienvenido : " + User.Identity.Name);%></a></h1>
											...
											<nav id="nav">
												<ul>
													...
													<li>
														<span>MENU</span>
														<ul>
															<li><a href="SignOut.aspx">"Cerrar Sesion"</a></li>
															
															<li>
																<span>Ajustes de simulacion</span>
																<ul>
																	<li><a href="  parInter.aspx"  target="iframe_a">Ajuste de Parametros internos</a></li>
																	<li><a href="parExter.aspx" target="iframe_a">Ajuste de Parametros Externos</a></li>
																	<li><a href="salFoto.aspx?session=1" target="iframe_a">Guardar Fotograma</a></li>
																	<li><a href="carFoto.aspx" target="iframe_a">Cargar Fotograma</a></li>
																</ul>
															</li>
															<li><a href="execute.aspx?session=1" target="iframe_a">Iniciar Instancia de simulacion</a></li>
                                                            <li><a href="kill.aspx?session=1" target="iframe_a">Terminar Instancia de simulacion</a></li>
														</ul>
													</li>
...
<iframe src="intro.aspx" seamless name="iframe_a"  width="100%" height="500"></iframe>
							<!-- Banner -->
