...
#include "../plugins/anumindicatorplugin.h"
...
void ANumIndicatorPlugin::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    Q_UNUSED(_o);
    Q_UNUSED(_id);
    Q_UNUSED(_c);
...
const QMetaObjectExtraData ANumIndicatorPlugin::staticMetaObjectExtraData = {
...
const QMetaObject ANumIndicatorPlugin::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_ANumIndicatorPlugin,
      qt_meta_data_ANumIndicatorPlugin, &staticMetaObjectExtraData }
};
