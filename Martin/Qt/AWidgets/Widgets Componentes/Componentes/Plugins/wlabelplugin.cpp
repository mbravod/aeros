...
{
    return QLatin1String("Componentes_Modificados");
}
...
{
    return QLatin1String("Actualizacion");
}

QString WLabelPlugin::whatsThis() const
{
    return QLatin1String("Widgets modificados para la presentación de la vista del sistema SiTTuGAs.");
}
