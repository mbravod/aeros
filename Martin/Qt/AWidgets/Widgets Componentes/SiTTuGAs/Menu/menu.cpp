    ...
    ui(new Ui::Menu)
{
    ...
    connect(ui->btnBOP, SIGNAL(clicked()),this,SLOT(sltBoton()));
    connect(this,SIGNAL(ActivaVista(int)),this,SLOT(sltActivaVista(int)));
...
void Menu::sltBoton()
{
    //Asignamos el id 41 al boton BOP
    emit (ActivaVista(41);)

}

void Menu::sltActivaVista(int id)
{
    emit (id);
}
