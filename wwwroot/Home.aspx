...
<script runat="server">
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (System.Web.HttpContext.Current.User.Identity.IsAuthenticated)
        {
            ...
            string resp = "USER=" + User.Identity.Name + ";" + "UTC=" + Nounce4 + ";" + "SESSION=" + session + ";";
            resp = resp + "KEY=" + "l3MYTtoJEPUIBsLQTEJsRcmaWuRfmmi0" + ";";  //la clave es en funcion de la sesion a futuro
            string hash;
            ...
            byte[] key;
            key = new byte[32];
            string strkey = "X$chaz9809ca_Meaw_Clave_S1lv3str";  //Esta es la Clave GLobal 
            ...
            {
                resp = "IV=" + "AAA" + ";";
                resp = resp + "SIGNATURE=" + "AAA" + ";";
            }
            
             byte [] datakey = System.Text.Encoding.ASCII.GetBytes(resp);



             string datakey64 = System.Convert.ToBase64String(datakey, 0, datakey.Length);
             codedlink = datakey64;
							...
							<!-- Banner -->
								<div id="banner">
                                  ...
                                  <% 
                                      ...
                                      Response.Write("<a href=\"CSIM://"+ codedlink+ "\" class=\"button button-big button-icon button-icon-check\">Iniciar App</a>");%>  
