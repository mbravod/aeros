...
//       this->setI(1,105);
       qDebug()<<"Valor de prueba 1160: "<<memi[1160];

/*       for(int jy = 0; jy < 32000; jy++)
       {
           if(memi[jy] != 0)
           {
               qDebug()<<"Valor de prueba "<<jy<<": "<<memi[jy];
           }
       }*/
...
int HTTPRequest::getI(int pos)
{
    if(0 <= pos)
    {
        qDebug()<<"Solicitan posición: "<<pos<<" valor: "<<HTTPRequest::memi[pos];
