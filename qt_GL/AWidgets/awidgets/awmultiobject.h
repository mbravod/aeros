...
public:
    ...
    enum ETypes{VH2=0,CIRLED,VALCUAD2,VALCUAD3,VALSIMP3,VALSIMP4,VALELE2,AGITADOR,INTER,INTERM,BOMBATA,BOMBATB,BOMBATC,BOMBATD,BOMBATE,REGTA,SPRING,CIRLINE,TELEM,SQUARE,ASPTA,ASPTB,FLAME,BOMBAFT,TRIANGULO};
...
protected:
    ...
    bool encontrado;
public slots:
        void Update(); //Este metodo podria ser publico
